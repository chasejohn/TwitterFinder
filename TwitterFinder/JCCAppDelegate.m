...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //JCCUserListViewController *controller =
    //(JCCUserListViewController *)navigationController.topViewController;
    //controller.dataSource = [[JCCTwitterUserSource alloc] init];
    return YES;
}
